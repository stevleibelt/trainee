...
use Trainee\Database\map\AlbumTableMap;

/**
 * Base static class for performing query and update operations on the 'trainee_orm_propel1_album' table.
 *
 *
 *
...
abstract class BaseAlbumPeer
{
    ...
    const TABLE_NAME = 'trainee_orm_propel1_album';

    /** the related Propel class for this table */
    const OM_CLASS = 'Trainee\\Database\\Album';

    /** the related TableMap class for this table */
    const TM_CLASS = 'Trainee\\Database\\map\\AlbumTableMap';
    ...
    const ID = 'trainee_orm_propel1_album.id';

    /** the column name for the interpret_id field */
    const INTERPRET_ID = 'trainee_orm_propel1_album.interpret_id';

    /** the column name for the title field */
    const TITLE = 'trainee_orm_propel1_album.title';

    /** the column name for the number_of_tracks field */
    const NUMBER_OF_TRACKS = 'trainee_orm_propel1_album.number_of_tracks';
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'InterpretId', 'Title', 'NumberOfTracks', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'interpretId', 'title', 'numberOfTracks', ),
        BasePeer::TYPE_COLNAME => array (AlbumPeer::ID, AlbumPeer::INTERPRET_ID, AlbumPeer::TITLE, AlbumPeer::NUMBER_OF_TRACKS, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID', 'INTERPRET_ID', 'TITLE', 'NUMBER_OF_TRACKS', ),
        BasePeer::TYPE_FIELDNAME => array ('id', 'interpret_id', 'title', 'number_of_tracks', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'InterpretId' => 1, 'Title' => 2, 'NumberOfTracks' => 3, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'interpretId' => 1, 'title' => 2, 'numberOfTracks' => 3, ),
        BasePeer::TYPE_COLNAME => array (AlbumPeer::ID => 0, AlbumPeer::INTERPRET_ID => 1, AlbumPeer::TITLE => 2, AlbumPeer::NUMBER_OF_TRACKS => 3, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'INTERPRET_ID' => 1, 'TITLE' => 2, 'NUMBER_OF_TRACKS' => 3, ),
        BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'interpret_id' => 1, 'title' => 2, 'number_of_tracks' => 3, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, )
    );
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(AlbumPeer::INTERPRET_ID);
            $criteria->addSelectColumn(AlbumPeer::TITLE);
            $criteria->addSelectColumn(AlbumPeer::NUMBER_OF_TRACKS);
        } else {
            $criteria->addSelectColumn($alias . '.id');
            $criteria->addSelectColumn($alias . '.interpret_id');
            $criteria->addSelectColumn($alias . '.title');
            $criteria->addSelectColumn($alias . '.number_of_tracks');
        }
    }
    ...
    public static function addInstanceToPool($obj, $key = null)
    {
        if (Propel::isInstancePoolingEnabled()) {
            if ($key === null) {
                $key = serialize(array((string) $obj->getId(), (string) $obj->getInterpretId()));
            } // if key === null
    ...
    public static function removeInstanceFromPool($value)
    {
        if (Propel::isInstancePoolingEnabled() && $value !== null) {
            if (is_object($value) && $value instanceof Album) {
                $key = serialize(array((string) $value->getId(), (string) $value->getInterpretId()));
    ...
    /**
     * Method to invalidate the instance pool of all tables related to trainee_orm_propel1_album
    ...
    /**
     * Returns the number of rows matching criteria, joining the related Interpret table
     *
     * @param      Criteria $criteria
     * @param      boolean $distinct Whether to select only distinct columns; deprecated: use Criteria->setDistinct() instead.
     * @param      PropelPDO $con
     ...
     * @return int Number of matching rows.
     */
    public static function doCountJoinInterpret(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        $criteria->addJoin(AlbumPeer::INTERPRET_ID, InterpretPeer::ID, $join_behavior);
    ...
    /**
     * Selects a collection of Album objects pre-filled with their Interpret objects.
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
     ...
     *		 rethrown wrapped into a PropelException.
     */
    public static function doSelectJoinInterpret(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $criteria = clone $criteria;
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            $key2 = InterpretPeer::getPrimaryKeyHashFromRow($row, $startcol);
            if ($key2 !== null) {
                $obj2 = InterpretPeer::getInstanceFromPool($key2);
                if (!$obj2) {
                    ...
                    InterpretPeer::addInstanceToPool($obj2, $key2);
                } // if obj2 already loaded

                // Add the $obj1 (Album) to $obj2 (Interpret)
                $obj2->addAlbum($obj1);
    ...
    public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        InterpretPeer::addSelectColumns($criteria);
        $startcol3 = $startcol2 + InterpretPeer::NUM_HYDRATE_COLUMNS;
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            // Add objects for joined Interpret rows

            $key2 = InterpretPeer::getPrimaryKeyHashFromRow($row, $startcol2);
            if ($key2 !== null) {
                $obj2 = InterpretPeer::getInstanceFromPool($key2);
                if (!$obj2) {
                ...
                // Add the $obj1 (Album) to the collection in $obj2 (Interpret)
                $obj2->addAlbum($obj1);
    ...
    public static function buildTableMap()
    {
      ...
      if (!$dbMap->hasTable(BaseAlbumPeer::TABLE_NAME)) {
        $dbMap->addTableObject(new \Trainee\Database\map\AlbumTableMap());
      }
    }
    ...
    public static function doUpdate($values, PropelPDO $con = null)
    {
        ...
        if ($values instanceof Criteria) {
            ...
            $comparison = $criteria->getComparison(AlbumPeer::INTERPRET_ID);
            $value = $criteria->remove(AlbumPeer::INTERPRET_ID);
            if ($value) {
                $selectCriteria->add(AlbumPeer::INTERPRET_ID, $value, $comparison);
            } else {
                $selectCriteria->setPrimaryTableName(AlbumPeer::TABLE_NAME);
            }
    ...
    /**
     * Deletes all rows from the trainee_orm_propel1_album table.
     *
     * @param      PropelPDO $con the connection to use
     * @return int             The number of affected rows (if supported by underlying database driver).
     ...
     public static function doDelete($values, PropelPDO $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            ...
            foreach ($values as $value) {
                $criterion = $criteria->getNewCriterion(AlbumPeer::ID, $value[0]);
                $criterion->addAnd($criteria->getNewCriterion(AlbumPeer::INTERPRET_ID, $value[1]));
                $criteria->addOr($criterion);
                // we can invalidate the cache for this single PK
                AlbumPeer::removeInstanceFromPool($value);
            }
        }
     ...
     * @param   int $id
     * @param   int $interpret_id
     * @param      PropelPDO $con
     * @return Album
     */
    public static function retrieveByPK($id, $interpret_id, PropelPDO $con = null) {
        $_instancePoolKey = serialize(array((string) $id, (string) $interpret_id));
         if (null !== ($obj = AlbumPeer::getInstanceFromPool($_instancePoolKey))) {
             return $obj;
        }
        ...
        $criteria = new Criteria(AlbumPeer::DATABASE_NAME);
        $criteria->add(AlbumPeer::ID, $id);
        $criteria->add(AlbumPeer::INTERPRET_ID, $interpret_id);
