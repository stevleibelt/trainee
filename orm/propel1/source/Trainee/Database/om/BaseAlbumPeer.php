...
/**
 * Base static class for performing query and update operations on the 'trainee_orm_propel1album' table.
 *
 *
 *
...
abstract class BaseAlbumPeer
{
    ...
    const TABLE_NAME = 'trainee_orm_propel1album';
    ...
    const ID = 'trainee_orm_propel1album.id';

    /** the column name for the interpret_id field */
    const INTERPRET_ID = 'trainee_orm_propel1album.interpret_id';

    /** the column name for the title field */
    const TITLE = 'trainee_orm_propel1album.title';

    /** the column name for the number_of_tracks field */
    const NUMBER_OF_TRACKS = 'trainee_orm_propel1album.number_of_tracks';
    ...
    /**
     * Method to invalidate the instance pool of all tables related to trainee_orm_propel1album
    ...
    /**
     * Deletes all rows from the trainee_orm_propel1album table.
     *
     * @param      PropelPDO $con the connection to use
     * @return int             The number of affected rows (if supported by underlying database driver).
