...
/**
 * This class defines the structure of the 'trainee_orm_propel1album' table.
 *
 *
...
class AlbumTableMap extends TableMap
{
    ...
    {
        // attributes
        $this->setName('trainee_orm_propel1album');
        ...
        $this->addForeignPrimaryKey('interpret_id', 'InterpretId', 'INTEGER' , 'trainee_orm_propel1interpret', 'id', true, 11, null);
